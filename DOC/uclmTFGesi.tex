...
\begin{abstract}
El consumo de energía juega un papel fundamental en el progreso y bienestar de la sociedad. Tanto es así que la demanda de energía se multiplica con el paso del tiempo y su precio aumenta. Además, las fuentes de energía fósiles son agotables y se debe apostar por el uso de energías renovables tanto como sea posible. Para lidiar con ello se debería obtener energía de numerosas fuentes, teniendo en cuenta los factores que las condicionan y seleccionando la más adecuada en cada momento, sin depender de una única fuente energética para satisfacer la demanda como ocurre mayoritariamente en la actualidad.\\

Este Trabajo Fin de Grado propone la creación de un sistema inteligente para que la gestión de energía en hogares se realice de la manera más óptima y eficiente posible mediante la instalación de módulos fotovoltaicos y una batería. Este tipo de instalación se modela como un problema de satisfacción de restricciones (PSR) identificándose un conjunto de variables, el dominio de las mismas y un conjunto de restricciones entre valores de las variables que siempre vienen determinadas por la configuración de la instalación y por las propias propiedades físicas de generación y consumo de la energía, así como de las condiciones climáticas. A este PSR se le añade una función objetivo que permite optimizar la solución del mismo orientándolo a la minimización de dicha función mediante programación lineal, lo que va a permitir el máximo aprovechamiento de la energía y da como resultado un coste económico mínimo para el hogar. Este sistema es usable mediante una aplicación web alojada en la nube de IBM Cloud Foundry y Amazon Web Services que permite interactuar a los usuarios con el sistema, configurando las características de su hogar y pudiendo realizar simulaciones de un día concreto. Gracias a los resultados de estas simulaciones, los usuarios pueden comparar la distribución energética y gasto económico que se hubiera producido empleando el sistema propuesto frente a lo ocurrido realmente con el consumo exclusivo de la red eléctrica.
