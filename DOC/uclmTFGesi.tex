...
\usepackage[			% Márgenes del documento
	...
	inner=2.5cm,		% Margen al interior (Margen mayor debido a la encuadernacion. Asegurarse)
...
\hypersetup{%	
	pdftitle={TFG_PalominoGomezPablo}, 	% Título
...
\dedicado{Dedicatoria\\%A mis padres y a Nuria ... \\ % A alguien muy especial
