...
El consumo de energía juega un papel fundamental en el progreso y bienestar de la sociedad. Tanto es así que la demanda de energía se multiplica con el paso del tiempo y su precio aumenta. Además, las fuentes de energía fósiles son agotables y se debe apostar por el uso de energías renovables y autoconsumo tanto como sea posible. Para gestionar de la forma mas eficiente esta multitud de fuentes de energía tenemos que tener en cuenta los factores que las condicionan y seleccionar la más adecuada en cada momento para satisfacer la demanda de energía.\\

Este Trabajo Fin de Grado propone la creación de un sistema inteligente para que la gestión de energía en hogares se realice de una manera óptima y eficiente mediante la consideración de incorporar nuevas fuentes de energía como son la instalación de módulos fotovoltaicos y una batería. La instalación se modela como un problema de satisfacción de restricciones (PSR) identificándose un conjunto de variables, el dominio de las mismas y un conjunto de restricciones entre valores de las variables que siempre vienen determinadas por la configuración de la instalación, por las propiedades físicas de generación y consumo de la energía, así como por las condiciones climáticas. A este PSR se le añade una función objetivo de coste energético que permite hallar la solución del mismo orientándolo a la minimización de dicha función mediante programación lineal. Esto permite el máximo aprovechamiento de la energía y da como resultado un coste económico mínimo para el hogar. Este sistema es usable mediante una aplicación web alojada en la nube de IBM Cloud Foundry y Amazon Web Services que permite interactuar a los usuarios con el sistema, configurando las características de su hogar y pudiendo realizar simulaciones de un día concreto. Gracias a los resultados de estas simulaciones, los usuarios pueden comparar la distribución energética y gasto económico que se hubiera producido empleando el sistema propuesto frente a lo ocurrido realmente con el consumo exclusivo de la red eléctrica.
...
**** IGNORAR, SE TRADUCIRÁ CUANDO EL NUEVO RESUMEN ESTÉ APROBADO ****
