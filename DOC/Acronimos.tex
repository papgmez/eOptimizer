...
\newglossaryentry{AEMET}{name=AEMET, description={Agencia estatal de meteorología}}
...
\newglossaryentry{GLP}{name=GNU GLP, description={Licencia pública general de GNU (Proyecto colaborativo de software libre)}}
\newglossaryentry{RGPD}{name=RGPD, description={Reglamento general de protección de datos}}
